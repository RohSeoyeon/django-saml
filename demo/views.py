...
from custom_auth.backend import save_saml_user_data
...
def index(request):
    ...
    if 'sso' in req['get_data']:
        ...
        if not errors:
            ...
            # Save user data from SAML response
            if 'SAMLResponse' in req['post_data']:
                saml_response_data = req['post_data']['SAMLResponse']
                user = save_saml_user_data(saml_response_data)
                request.user = user
                user_id = user.id
